...
with transaction.atomic():
    for i, r in df.iterrows():
        ...
        try:
            ...
            s1 = r['(1) ความสวยงาม']
            s1_inst = Score(poster=poster, referee=referee, question=q1, value=s1)
        except Exception as err:
            is_pass = False
            print('--- Invalid Q1---')
            print(i, r)
        ...
        try:
            ...
            s2_inst = Score(poster=poster, referee=referee, question=q2, value=s2)
        except Exception as err:
            is_pass = False
            print('--- Invalid Q2---')
            print(i, r)
        ...
        try:
            ...
            s3 = r['(3) การนำเสนอ']
            s3_inst = Score(poster=poster, referee=referee, question=q3, value=s3)
        except Exception as err:
            is_pass = False
            print('--- Invalid Q3---')
            print(i, r)
